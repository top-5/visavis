...
const validateSource = (source: Source): boolean => {
  ...
  if (source instanceof Blob) {
    // When models fetched from GitHub it returns Content-Type: application/octet-stream
    return source.type === 'model/gltf-binary' || source.type === 'application/octet-stream';
  }
...
export const useHeadMovement = ({
  ...
  useFrame((state) => {
    ...
    if (true) {
      // cameraToHeadDistance < activeDistance && cameraRotation < activeRotation) {
